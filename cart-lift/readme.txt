...
<h4><a href="https://rextheme.com/cart-lift/?utm_source=Repo-CTA&utm_medium=CartLift-Repo&utm_campaign=eid-ul-fitr-2025" target="_blank">🔥 Get Cart Lift - Abandoned Cart Recovery For WooCommerce & EDD (Pro) Now at a 20% Discount! 🔥</a> </h4>
...
==📊 Get Detailed Cart Analytics On Revenue Recovered 📊==
The plugin gives you an accurate analytics board where you can know exactly,

- How many abandoned carts do you face,
- How much the abandoned carts were worth,
- How many carts were you successfully able to recover, and
- How much revenue you earned through the abandoned cart recovery emails

==📈 Easily Build Up Your Mailing List While Clients Shop 📈==
A special feature of the plugin is the Add To Cart Popup Modal.

When a guest visitor clicks on the Add To Cart button, a persuasive pop-up will appear and ask for the email address.

A great way to grow your mailing list and increase the abandoned cart recovery rate.
...
The plugin is compatible with any theme and can handle any abandoned carts you face through WooCommerce or Easy Digital Downloads.
...
* Exit Intent Popup
* Weekly Email Report to site Admin

>  Want to know more about Cart Lift Pro? [Then click here!](https://rextheme.com/cart-lift/)

>  We have many more amazing features planned. Take look at [our development roadmap.](https://airtable.com/shrAcjsimKeoAEiVT/tblcz5dQzaQZx9kFl)


> *[Have a suggestion or feature request? Let us know!](https://airtable.com/shrAcjsimKeoAEiVT/tblcz5dQzaQZx9kFl)*

## Privacy Policy
Cart Lift uses [Appsero](https://appsero.com) SDK to collect some telemetry data upon the user's confirmation. This helps us to troubleshoot problems faster & make product improvements.
...
Follow the steps in this guide: [How to upgrade to Cart Lift Pro](https://rextheme.com/docs/cart-lift-upgrade-to-pro/).
...
* Fix: Greek text encoding issue in subject fields.
...
* Added: New setup wizard for easy configuration

= 3.1.14 (2024-06-13) =
* Fixed: Fix EDD abandoned cart tracking issue

= 3.1.13 (2024-05-22) =
* Fixed: Js error on the admin side
...
= 3.1.11 (2024-01-18) =
* Fixed: PHP fatal error - [Support Ticket](https://wordpress.org/support/topic/php-error-624/)

= 3.1.10 (2023-11-17) =
* Compatibility: Compatible with WooCommerce HPOS / High-Performance Order Storage - [Support Ticket](https://wordpress.org/support/topic/incompatible-with-hpos-4/)

= 3.1.9 (2023-10-19) =
* Fixed: Broken checkout url issue - [Support Ticket](https://wordpress.org/support/topic/broken-if-your-checkout-url-already-has-params-such-as-nocachetrue/)

= 3.1.8 (2023-08-08) =
* Enhancement: Add multiple new blank lines in campaign email editor
* Fixed: Product pricing issue for variation products

= 3.1.7 (2023-06-21) =
* Added: Filter `cl_email_body_custom_style` added for custom email body styling
* Fixed: Unnecessary log recording removed

= 3.1.6 (2023-03-01) =
* Fix - Optimize cart search function on admin to prevent potential security issues

= 3.1.5 (2022-12-29) =
* Fixed - PHP warnings
* Fixed - Abandoned cart product pricing mismatch
