 ...
 <?php
/**
 * Cart Lift CRO (Conversion Rate Optimization) Implementation
 *
...
<!-- Pro Modal -->
<section class="cartlift-cro-modal" id="cartlift_premium_feature_popup" style="display: none;">
    <div class="cartlift-cro-modal__wrapper">
        <span class="cartlift-cro-modal__close-btn" id="cartlift_premium_feature_close">
            <svg fill="none" viewBox="0 0 22 22"><g stroke="#A8B3C7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" clip-path="url(#clip0_1_11)"><path d="M16.5 5.5l-11 11M5.5 5.5l11 11"/></g><defs><clipPath id="clip0_1_11"><path fill="#fff" d="M0 0h22v22H0z"/></clipPath></defs></svg>
        </span>
        <div class="cartlift-cro-modal__body">
            <div class="cartlift-cro-modal__message">
                <span class="cartlift-cro-modal__svg-icon">
                <svg width="114" height="96" viewBox="0 0 114 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M32 71.9351C24.4247 70.7671 23.3425 67.4087 21.9366 57C20.954 66.876 19.7021 70.621 12 71.7469C18.7172 74.5633 21.0786 75.5852 22.2785 87C23.9334 75.4393 25.4073 74.4172 32 71.9351Z" fill="#6E42D3"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.8091 47.9512C7.33608 47.2512 6.69721 45.2385 5.86713 39C5.28757 44.9191 4.54782 47.1637 0 47.8385C3.96697 49.5264 5.3611 50.139 6.06851 56.9805C7.04565 50.0515 7.91712 49.4389 11.8091 47.9512Z" fill="#EE8134"/>
                    <circle cx="63" cy="48" r="48" fill="#EE8134" fill-opacity="0.1"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M65.9115 29.8177C64.3273 27.3941 60.7315 27.3941 59.1473 29.8177L51.1486 42.0535L45.0348 38.5896C41.9718 36.8542 38.2891 39.5738 39.1188 42.9584L43.2724 59.9021C43.4594 60.6652 44.1521 61.2026 44.9484 61.2026H80.1104C80.9068 61.2026 81.5995 60.6652 81.7866 59.9021L85.94 42.9584C86.7699 39.5738 83.0871 36.8542 80.024 38.5896L73.9101 42.0535L65.9115 29.8177ZM63.0125 31.6584C62.7864 31.3122 62.2725 31.3122 62.0464 31.6584L53.1599 45.2522C52.6624 46.0132 51.6472 46.2562 50.851 45.8052L43.316 41.5361C42.8785 41.2882 42.3524 41.6768 42.4709 42.1603L46.3057 57.8038H78.7532L82.588 42.1603C82.7064 41.6768 82.1805 41.2882 81.7428 41.5361L74.2078 45.8052C73.4115 46.2562 72.3965 46.0132 71.8991 45.2522L63.0125 31.6584Z" fill="#EE8134"/>
                    <path d="M46.4365 64.6012C45.4842 64.6012 44.7122 65.3621 44.7122 66.3007C44.7122 67.2391 45.4842 68 46.4365 68H78.6233C79.5755 68 80.3475 67.2391 80.3475 66.3007C80.3475 65.3621 79.5755 64.6012 78.6233 64.6012H46.4365Z" fill="#EE8134"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M114 26.961C109.455 26.2602 108.806 24.2452 107.962 18C107.372 23.9256 106.621 26.1726 102 26.8481C106.03 28.538 107.447 29.1511 108.167 36C109.16 29.0636 110.044 28.4503 114 26.961Z" fill="#6E42D3"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M108.809 74.9512C104.336 74.2512 103.697 72.2385 102.867 66C102.288 71.9191 101.548 74.1637 97 74.8385C100.967 76.5264 102.361 77.139 103.069 83.9805C104.046 77.0515 104.917 76.4389 108.809 74.9512Z" fill="#EE8134"/>
                    </svg>
                </span>

                <h4 class="cartlift-cro-modal__heading">
                    <?php esc_html_e( 'This is a Premium Feature', 'wpvr' ); ?>
                </h4>

                <p class="cartlift-cro-modal__subheading">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        let discountLabel = document.querySelector(".cartlift-cro-modal__discount-price-label");
        if (discountLabel) {
